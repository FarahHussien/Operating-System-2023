...
///////////////////////////////////////////////////////////////////////////////////////
			...
			{
					cprintf("======if(!(perms & PERM_USER)&&(perms & PERM_PRESENT))====");
				...
				sched_kill_env(faulted_env->env_id);
					...
					&& !(perms & PERM_MARKED))
			{
				cprintf("======if((fault_va >= USER_HEAP_START && fault_va <USER_HEAP_MAX)====");
			...
			{
				cprintf("======if(!(perms & PERM_WRITEABLE)&&(perms & PERM_PRESENT))====");
...
///////////////////////////////////////////////////////////////////////////////////////////
		//	if((fault_va >= KERNEL_HEAP_START && fault_va <KERNEL_HEAP_MAX) ||
			//		(perms & ~PERM_WRITEABLE && perms & PERM_PRESENT))
		//	{
		//		cprintf("in invalid param");
			//	sched_kill_env(curenv->env_id);
			//}
